"""Benchmark: DSA and the vectorized wavefront sweep in the 2D S_N solver.

Two problems, each solved by every (acceleration, sweep) combination:
...
CASES = [
    ...
    ("gmres + wavefront", dict(acceleration="gmres")),
    ("si    + wavefront", dict(acceleration="si")),
    ("dsa   + wavefront", dict(acceleration="dsa")),
