...
stage_root="/data/scratch/shared/poncet_m/ndgpu-multigpu-phase7-gh"
...
sbatch --clusters=gmerlin7 --export="ALL,NDGPU_STEP_SOLVER=${step_solver}" \
    "${stage_root}/repo/slurm/run_ndgpu_phase7_gh_extruded_gate.sh"
