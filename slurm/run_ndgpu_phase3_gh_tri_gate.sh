...
#SBATCH --job-name=ndgpu-p3-tri-gh
...
#SBATCH --output=/data/scratch/shared/poncet_m/ndgpu-multigpu-phase3/logs/gh-tri-%j.log
#SBATCH --error=/data/scratch/shared/poncet_m/ndgpu-multigpu-phase3/logs/gh-tri-%j.log
...
printf 'NDgpu Phase 3 multi-GH triangular gate: host=%s tasks=%s repo=%s\n' \
...
srun --mpi=pmix --ntasks=2 --kill-on-bad-exit=1 --cpu-bind=cores \
    ...
    --device gpu --communication host-staged --refine 32 --angle 120
