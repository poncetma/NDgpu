...
sbatch --clusters=gmerlin7 --ntasks=2 --time=00:30:00 \
    --chdir="${stage_root}/logs" \
    --output="${stage_root}/logs/transient-%j.log" \
    --error="${stage_root}/logs/transient-%j.log" \
    --export=ALL,NDGPU_MPI_COMMUNICATION=cuda-aware,NDGPU_SINGLE_REDUCTION=1,NDGPU_BATCHED_HALOS=1 \
